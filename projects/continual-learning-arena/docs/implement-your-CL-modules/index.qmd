...
You can define your custom CL modules outside the package source code, and specify the `_target_` fields in your configs. Suppose you have a project directory tree like this (you can also take [my CL research project]() as an example):
