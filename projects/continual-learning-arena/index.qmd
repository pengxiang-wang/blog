...
[PyPI](https://pypi.org/project/clarena/){.btn .btn-warning role="button"}
...
Continual learning is a paradigm of machine learning that deals with learning new tasks sequentially without forgetting previous ones. Feel free to check out my [beginner's guide for continual learning](../../posts/continual-learning-beginners-guide.qmd) if you haven't know much about CL yet.
