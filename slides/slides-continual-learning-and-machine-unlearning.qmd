...
- Compare CL metrics: for example, test task a, b, c (without unlaerning) and task a, c (unlearing b) to see the difference
- Choose a suitable archietcture-based method of fix network. Their network isolation ideas make it naturally easy for unealrning
