...
---
<!-- TITLE -->
\begin{huge}\begin{center}{\bf PENGXIANG (SHAWN) WANG}\end{center}\end{huge}

<!-- CONTACT INFO -->
\begin{center}\href{mailto::shawn.pxwang@gmail.com}{shawn.pxwang@gmail.com} ∙ \href{https://pengxiang-wang.com}{Homepage} ∙ \href{https://www.linkedin.com/in/pengxiang-wang-25643b1a5/}{LinkedIn} ∙ \href{https://github.com/pengxiang-wang}{GitHub} ∙ \href{https://scholar.google.com/citations?user=RkFkhpAAAAAJ&hl=en}{Google Scholar}
\end{center}
\vspace{5pt}

**Summary:** PhD candidate in applied mathematics, math background + 5 years of experience focusing on **machine learning**, currently researching **continual learning**
...
\begin{large}
  ...
  \begin{multicols}{2}
    ...
    \includegraphics[height=2em]{../assets/uob-logo-simple.jpg}
      \hspace{1 mm} {\bf \href{https://www.bristol.ac.uk}{University of Bristol},} \\
